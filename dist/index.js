...
function rehypeWrapElement({ target, wrapper }) {
    ...
    let { element: targetElement, className: targetClassName } = assignOptions(target);
    let { element: wrapperElement, className: wrapperClassName } = assignOptions(wrapper);
    /**
